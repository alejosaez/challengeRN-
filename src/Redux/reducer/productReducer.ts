    ...
    builder
      ...
      .addCase(
        ...
        (state, action: PayloadAction<Product>) => {
          ...
          console.log(
            'Producto actualizado recibido en fulfilled:',
            updatedProduct,
          )
          ...
          if (index !== -1) {
            ...
            console.log(
              'Producto antes de la actualización:',
            ...
            console.log(
              'Producto no encontrado en allProducts para actualizar.',
            )
          }
        },
      )
      ...
      .addCase(
        ...
        (state, action: PayloadAction<ProductSearchResponse[]>) => {
          state.loading = false
